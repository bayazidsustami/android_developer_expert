package com.dicoding.course.mysimplereactive
...
import com.dicoding.course.mysimplereactive.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val invalidFieldStream = Observable.combineLatest(
            ...
            { emailValid: Boolean, passwordValid: Boolean, passwordConfirmation: Boolean ->
                !emailValid && !passwordValid && !passwordConfirmation
            })
